...
//  if (false) {
//    lazy val datasets = Source.fromFile("p2-spambase-wine5.txt").getLines().toList.filter(!_.startsWith("#"))
...
//    }
//
//    datasets.filter(!Seq().contains(_)) foreach { dataset =>
