...
//
//case class Ag(hlimit:Int, learner:Learner, pool: Seq[Pattern], distance_name: String, alpha: Double = 1, beta: Double = 1, debug: Boolean = false)
...
//         if (histMin >= hlimit) (1 - margin(model)(x)) * dens else dens
//      }
//      selected
//   }
//}