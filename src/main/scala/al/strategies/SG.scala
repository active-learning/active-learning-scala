...
case class SG(learner: Learner, pool: Seq[Pattern], agreement: String, debug: Boolean = false)
  extends StrategySG {
  ...
  def controversial(unlabeled0: Seq[Pattern], current_models: Array[Model]) = {
