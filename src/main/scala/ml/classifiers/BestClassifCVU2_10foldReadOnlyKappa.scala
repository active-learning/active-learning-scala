...
case class BestClassifCVU2_10foldReadOnlyKappa(ds: Ds, r: Int, f: Int, s: Strategy) extends Learner {
   override lazy val toString = s"BcvU210fk($ds,${s.limpa},$r,$f):${classif.limpa}"
