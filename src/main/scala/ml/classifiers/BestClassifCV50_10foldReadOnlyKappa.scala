...
case class BestClassifCV50_10foldReadOnlyKappa(ds: Ds, r: Int, f: Int, s: Strategy) extends Learner {
   override lazy val toString = s"Bcv5010fk($ds,${s.limpa},$r,$f):${classif.limpa}"
