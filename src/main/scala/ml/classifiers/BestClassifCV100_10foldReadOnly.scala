...
case class BestClassifCV100_10foldReadOnly(ds: Ds, r: Int, f: Int, s: Strategy) extends Learner {
   override lazy val toString = s"Bcv10010f($ds,${s.limpa},$r,$f):${classif.limpa}"
