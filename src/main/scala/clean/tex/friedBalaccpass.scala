...
object friedBalaccpass extends AppWithUsage with LearnerTrait with StratsTrait with MeasuresTrait with RangeGenerator {
   ...
   override def run() = {
      println(s"sou um bug     kjfhkcfjhcjvhb")
      //mudei tudo
      super.run()
