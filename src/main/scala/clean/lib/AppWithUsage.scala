...
trait AppWithUsage extends App with Log with ArgParser {
   ...
   val humanNumAttsNames = "\"#classes\",\"#atributos\",\"#exemplos\",\"#exemplos/#atributos\",\"%nominais\",\"#exs/#atrs\",\"%majoritária\",\"%minoritária\",\"%majoritária/%minoritária\",\"entropia da classe\""
