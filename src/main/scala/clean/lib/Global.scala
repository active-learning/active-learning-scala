...
*/
object Global {
   val stratsSemLExt = Seq(292212, 1006600, 10066, 966000, 967000, 968000, 969000, 966009, 967009, 968009, 969009)

   val specialIds = Seq(211, 601, 361, 66361, 901, 391, 66391, 701, 371, 599996, 599997, 599998, 599999) //, 1006600, 10066)
