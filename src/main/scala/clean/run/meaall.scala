...
//            val k = Kappaa(ds, Passive(poolt), learner, run, fold)(-1)
//            val b = BalancedAcca(ds, Passive(poolt), learner, run, fold)(-1)
...
//            val k = Kappaa(ds, Passive(fpoolt), flearner, run, fold)(-1)
//            val b = BalancedAcca(ds, Passive(fpoolt), flearner, run, fold)(-1)
//            if (!k.existia || !b.existia) {
