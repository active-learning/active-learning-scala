...
//
final class Solver_NU extends svmalk.libsvm.Solver {
...
//
class SVC_Q extends svmalk.libsvm.Kernel {
...
class ONE_CLASS_Q extends svmalk.libsvm.Kernel {
    private final Cache cache;
...
class SVR_Q extends svmalk.libsvm.Kernel {
    private final int l;
    private final Cache cache;
...
public class svm {
    ...
    private static void solve_c_svc(svm_problem prob, svm_parameter param,
                                    double[] alpha, svmalk.libsvm.Solver.SolutionInfo si) {
        int l = prob.l;
    ...
    static decision_function svm_train_one(svm_problem prob, svm_parameter param) {
        ...
        svmalk.libsvm.Solver.SolutionInfo si = new svmalk.libsvm.Solver.SolutionInfo();
